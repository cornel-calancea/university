...
public final class GoodsFactory {
  ...
  private void initLegalGoods() {
    ...
    Goods good0 =
        new LegalGoods(
            LegalGoodsIds.APPLE,
            AssetsProfit.APPLE_PROFIT,
            LEGAL_PENALTY,
            KingBonus.APPLE,
            QueenBonus.APPLE);
    Goods good1 =
        new LegalGoods(
            LegalGoodsIds.CHEESE,
            AssetsProfit.CHEESE_PROFIT,
            LEGAL_PENALTY,
            KingBonus.CHEESE,
            QueenBonus.CHEESE);
    Goods good2 =
        new LegalGoods(
            LegalGoodsIds.BREAD,
            AssetsProfit.BREAD_PROFIT,
            LEGAL_PENALTY,
            KingBonus.BREAD,
            QueenBonus.BREAD);
    Goods good3 =
        new LegalGoods(
            LegalGoodsIds.CHICKEN,
            AssetsProfit.CHICKEN_PROFIT,
            LEGAL_PENALTY,
            KingBonus.CHICKEN,
            QueenBonus.CHICKEN);
    Goods good4 =
        new LegalGoods(
            LegalGoodsIds.TOMATO,
            AssetsProfit.TOMATO_PROFIT,
            LEGAL_PENALTY,
            KingBonus.TOMATO,
            QueenBonus.TOMATO);
    Goods good5 =
        new LegalGoods(
            LegalGoodsIds.CORN,
            AssetsProfit.CORN_PROFIT,
            LEGAL_PENALTY,
            KingBonus.CORN,
            QueenBonus.CORN);
    Goods good6 =
        new LegalGoods(
            LegalGoodsIds.POTATO,
            AssetsProfit.POTATO_PROFIT,
            LEGAL_PENALTY,
            KingBonus.POTATO,
            QueenBonus.POTATO);
    Goods good7 =
  ...
  private void initIllegalGoods() {
    ...
    Goods good0 =
        new IllegalGoods(IllegalGoodsIds.SILK, AssetsProfit.SILK_PROFIT, ILLEGAL_PENALTY, bonus0);
    Goods good1 =
        new IllegalGoods(
            IllegalGoodsIds.PEPPER, AssetsProfit.PEPPER_PROFIT, ILLEGAL_PENALTY, bonus1);
    Goods good2 =
        new IllegalGoods(
            IllegalGoodsIds.BARREL, AssetsProfit.BARREL_PROFIT, ILLEGAL_PENALTY, bonus2);
    Goods good3 =
        new IllegalGoods(IllegalGoodsIds.BEER, AssetsProfit.BEER_PROFIT, ILLEGAL_PENALTY, bonus3);
    Goods good4 =
        new IllegalGoods(
            IllegalGoodsIds.SEAFOOD, AssetsProfit.SEAFOOD_PROFIT, ILLEGAL_PENALTY, bonus4);
